...
gdt_entry_t gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_CODE_0] = {
            .limit_15_0 = GDT_LIMIT_LOW(GDT_LIMIT_4KIB(817)),
            .base_15_0 = 0x0000,
            .base_23_16 = 0x00,
            ...
            .dpl = 0x00,
            .p = 0x01,
            .limit_19_16 = GDT_LIMIT_HIGH((GDT_LIMIT_4KIB(817))),
            .avl = 0x0,
            .l = 0x0,
            .db = 0x1,
            .g = 0x01,
    ...
    [GDT_IDX_DATA_0] ={
            ...
            .s = DESC_CODE_DATA, //sistema no (0), codigo o dato si(1)
            .dpl = 0x00,
            .p = 0x01, //esta siempre en ram, disco no 
            .limit_19_16 = GDT_LIMIT_HIGH(GDT_LIMIT_4KIB(817)),
            .avl = 0x0,
            .l = 0x0,
            .db = 0x1,
